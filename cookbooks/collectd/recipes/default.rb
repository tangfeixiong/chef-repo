...
package "snmp-mibs-downloader" do
  package_name "snmp-mibs-downloader"
end

package "libhtml-parser-perl" do
  package_name "libhtml-parser-perl"
end

package "librrds-perl" do
  package_name "librrds-perl"
end

package "libhttp-lrdd-perl" do
  package_name "libhttp-lrdd-perl"
end

package "librrdp-perl" do
  package_name "librrdp-perl"
end
