...
cinder_user = "cinder"
cinder_password = node["grizzly"][role][cinder_user]["password"]
cinder_iscsi_target_path = node["grizzly"][role][cinder_user]["iscsi_target_path"]
mysql_cinder_password = node["grizzly"][role]["mysql"]["user_data"][cinder_user]["password"]
cinder_iscsi_target_path = node["grizzly"][role][cinder_user]["iscsi_target_path"]
cinder_iscsi_target_ip = node["grizzly"][role][cinder_user]["iscsi_target_ip"]
device = ""
dev = ""
