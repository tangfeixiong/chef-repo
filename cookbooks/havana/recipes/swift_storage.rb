...
config = partial_search(:node, 'role:havana_controller_node',
                        :keys => {
                            'private_ip' => ['havana', 'havana_controller_node', 'network', 'private', 'ip'],
                            'public_ip' => ['havana', 'havana_controller_node', 'network', 'public', 'ip'],
                            'token' => ['havana', 'havana_controller_node', 'admin', 'token'],
                            'swift_hash_path_suffix' => ['havana', 'havana_controller_node', 'swift', 'swift_hash_path_suffix']
                        }
).each do |result|
